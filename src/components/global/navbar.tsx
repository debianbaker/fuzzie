...
const navbar = async (props: Props) => {
    return ( 
        <header className ="fixed right-0 left-0 top-0 px-4 py-4 bg-black/40 backdrop-blur-lg z-[100] flex
        items-center border-b-[1px] border-neutral-900 justify-between">
            ...
            <aside className = "flex items-center gap-4">
                ...
                <UserButton/>  
                {/* for getting button from clerk for authenticated user */}
